...
public interface SentosaDatabaseStructure {
    ...
    public static class EventsPromotionsBase {
        ...
        public static final String ID_COL = _ID;
        public static final String TITLE_COL = "Title";
        public static final String DEAL_TYPE_COL = "DealType";
        public static final String DESCRIPTION_COL = "Description";
        ...
        public static final String DEAL_TYPE_JSON = "DealType";
        public static final String DISCOUNTED_TICKET_ENTITY_ID_JSON = "DiscountedTicketEntityId";
        public static final String DISCOUNTED_TICKET_ENTITY_TYPE_JSON = "DicountedTicketEntityType";
        public static final String REWARD_QUANTITY_JSON = "RewardQuantity";
        public static final String REWARD_QUANTITY_COUNT_JSON = "RewardQuantityCount";
        public static final String REWARD_DISPLAY_MESSAGED_JSON = "RewardDisplayMessaged";
    ...
    public static String TABLE_EVENTS_PROMOTIONS_CREATE = "CREATE TABLE "
            ...
            + " TEXT,"
            + EventsPromotionsBase.DEAL_TYPE_COL
            + " TEXT,"
